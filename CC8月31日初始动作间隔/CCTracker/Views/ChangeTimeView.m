...
-(void)awakeFromNib{
   NSDictionary * dic = [CCData dicFromCC];
    ...
    [_restPicker selectRow:0 inComponent:0 animated:YES];
     voiceclose = dic[@"voiceturnoff"];
    self.voiceSwitch.on = [NSNumber numberWithInteger:voiceclose.integerValue].boolValue;
    
    
    
    workTime = dic[@"padingtime"];
    restTime = dic[@"restduration"];
